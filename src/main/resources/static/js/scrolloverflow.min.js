...
!function (r, n, p) {
    var f = r.requestAnimationFrame || r.webkitRequestAnimationFrame || r.mozRequestAnimationFrame || r.oRequestAnimationFrame || r.msRequestAnimationFrame || function (t) {
        ...
        var e = {}, o = n.createElement("div").style, i = function () {
    ...
    function h(t, i, s) {
        var e = n.createElement("div"), o = n.createElement("div");
    ...
    t.prototype = {
        version: "5.2.0", _init: function () {
            ...
            if (this.enabled && m.eventType[t.type] === this.initiated) {
                ...
                var i, s, e, o, n = t.touches ? t.touches[0] : t, r = n.pageX - this.pointX, h = n.pageY - this.pointY,
                    a = m.getTime();
            ...
            if (this.enabled && m.eventType[t.type] === this.initiated) {
                ...
                var i, s, e = m.getTime() - this.startTime, o = p.round(this.x), n = p.round(this.y),
                    r = p.abs(o - this.startX), h = p.abs(n - this.startY), a = 0, l = "";
            ...
            var i = t ? m.removeEvent : m.addEvent, s = this.options.bindToWrapper ? this.wrapper : r;
            ...
            this.currentPage = {}, "string" == typeof this.options.snap && (this.options.snap = this.scroller.querySelectorAll(this.options.snap)), this.on("refresh", function () {
                var t, i, s, e, o, n, r = 0, h = 0, a = 0, l = this.options.snapStepX || this.wrapperWidth,
            ...
            var s = 0, e = this.pages.length, o = 0;
            ...
            var o = this.pages[t][i].x, n = this.pages[t][i].y;
            ...
            if (this.enabled) {
                var i, s = this.options.snap, e = s ? this.currentPage.pageX : this.x,
                    o = s ? this.currentPage.pageY : this.y, n = m.getTime(), r = this.keyTime || 0;
            ...
            var l = this, c = this.x, p = this.y, d = m.getTime(), u = d + h;
...
*/
    function (l, c) {
        l.fp_scrolloverflow = function () {
            ...
            var s = "fp-scrollable", n = "." + s, t = ".active", d = ".fp-section", e = d + t, o = ".fp-slide",
                u = ".fp-tableCell";
            ...
            function r() {
                ...
                function t(t) {
                    if (!fp_utils.hasClass(t, "fp-noscroll")) {
                        ...
                        var i, s, e, o = p.options.scrollOverflowHandler, n = o.wrapContent(),
                            r = fp_utils.closest(t, d), h = o.scrollable(t),
                        ...
                        var l = fp_utils.getWindowHeight(), c = l - a;
                        l < i + a ? null != h ? o.update(t, c) : (p.options.verticalCentered ? (fp_utils.wrapInner(f(u, t)[0], n.scroller), fp_utils.wrapInner(f(u, t)[0], n.scrollable)) : (fp_utils.wrapInner(t, n.scroller), fp_utils.wrapInner(t, n.scrollable)), o.create(t, c, p.iscrollOptions)) : o.remove(t), fp_utils.css(t, {overflow: ""})
                    }
                }
            ...
            var f = null, h = null, a = {
                ...
                setIscroll: function (t, i) {
                    if (a.hasBeenInit && t) {
                        var s = fp_utils.closest(t, n) || f(n, t) && f(n, t)[0], e = i ? "enable" : "disable";
                ...
                update: function (t, i) {
                    ...
                    }, 150), fp_utils.css(f(n, t)[0], {height: i + "px"}), h.verticalCentered && fp_utils.css(f(n, t)[0].parentNode, {height: i + "px"})
                },
