...
!function (e) {
    e.fn.imageUploader = function (t) {
        let n, i = {
            ...
            label: "드래그 & 드랍 하거나 클릭하여 사진 업로드",
            extensions: [".jpg", ".jpeg", ".png", ".gif", ".svg",".JPG",".JPEG",".PNG",".GIF"],
        ...
        let o = function () {
            ...
            e("<i>", {class: "fa fa-photo"}).appendTo(i), e("<span>", {text: a.settings.label}).appendTo(i);
            ...
            e("<i>", {class: "fa fa-close"}).appendTo(r);
            if (o) {
                l.attr("data-preloaded", !0);
                e("<input>", {type: "hidden", name: "photos", value: i}).appendTo(l)
            ...
            return !(a.settings.extensions.indexOf(e.name.replace(new RegExp("^.*\\."), ".")) < 0) || (alert(`형식에 맞지 않습니다. "${e.name}" 아래 확장자를 업로드할 수 있습니다."${a.settings.extensions.join('", "')}"`), !1)
        }, c = function (e) {
            ...
            return !(e + s.items.length + a.settings.preloaded.length >= a.settings.maxFiles) || (alert(`기억공유의 사진은 한장만 허용합니다. \n 여러 사진은 갤러리의 사진 추가를 이용해 주세요.`), !1)
        }, u = function (t, n) {
